'''Convert a grades file from the Intranet format into CDF
format. Takes Intranet filename as input. Prints to stdout.  The "out
of" field for each piece of work will need to be entered manually,
since for some reason it is not in the Intranet file.'''

ALL = 'all' # name of final term mark, to be computed as the weghted average
            # specified in the Intranet file
